<template>
    <div class="space-y-16 pb-24">
        ...
        <div class="relative min-h-[80vh] flex flex-col items-center justify-center text-center px-6 overflow-hidden">
            <!-- Ambient glow -->
            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#F5A623]/5 rounded-full blur-[120px] pointer-events-none" />
            ...
            <div class="relative z-10">
                ...
                <p class="text-[#F5A623] text-sm font-display font-medium tracking-widest uppercase mb-6">
                    Keep the canon
                </p>
                <p class="text-white/40 text-base sm:text-lg max-w-lg mx-auto leading-relaxed mb-10">
                    Master every franchise. Track your watch journey, never miss a detail, and keep your canon straight.
                </p>
                ...
                <div v-if="isLoggedIn" class="space-y-6">
                    <div class="flex items-center justify-center gap-6 text-center">
                        <div>
                            ...
                            <span class="block text-xs text-white/30 mt-1">Watched</span>
                        </div>
                        ...
                        <div>
                            ...
                            <span class="block text-xs text-white/30 mt-1">Complete</span>
                        </div>
                        <div class="w-px h-10 bg-white/10" />
                        <div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 justify-center">
                        <NuxtLink
                            to="/timeline"
                            class="px-8 py-3 rounded-xl bg-[#F5A623] text-[#0A0E1A] text-sm font-semibold hover:bg-[#FFB840] transition-colors inline-flex items-center justify-center gap-2"
                        >
                ...
                <div v-else class="space-y-4">
                    <NuxtLink
                        to="/onboarding"
                        class="px-10 py-3.5 rounded-xl bg-[#F5A623] text-[#0A0E1A] text-sm font-semibold hover:bg-[#FFB840] transition-colors inline-block"
                    >
                        Start your journey
                    </NuxtLink>
                    <div class="flex items-center justify-center gap-4 text-xs text-white/20">
                        <span>Already a Keeper?</span>
                        <NuxtLink to="/login" class="text-[#F5A623]/60 hover:text-[#F5A623] transition-colors underline underline-offset-2">
                            Sign in
                        </NuxtLink>
                    </div>
                </div>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6">
            <div class="text-center mb-10">
                <h2 class="font-display text-2xl sm:text-3xl font-bold tracking-tight text-white mb-2">Choose Your Franchise</h2>
                <p class="text-white/30 text-sm">Pick a universe to explore. More coming soon.</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <NuxtLink
                    to="/timeline"
                    class="group relative overflow-hidden rounded-2xl border border-[#F5A623]/20 bg-[#F5A623]/5 p-6 transition-all duration-300 hover:border-[#F5A623]/40 hover:bg-[#F5A623]/10"
                >
                    <div class="absolute top-3 right-3">
                        <span class="text-[10px] font-mono font-medium text-[#F5A623] bg-[#F5A623]/10 px-2 py-0.5 rounded-full">LIVE</span>
                    </div>
                    ...
                    <h3 class="font-display text-lg font-bold text-white mb-1">Marvel (MCU)</h3>
                    <p class="text-xs text-white/30 leading-relaxed">{{ totalTitles }} titles across the Infinity Saga, Multiverse Saga, and beyond.</p>
                    <div class="mt-4 flex items-center gap-1.5 text-[#F5A623] text-xs font-medium group-hover:gap-2.5 transition-all">
                        <span>Explore</span>
                ...
                <div class="relative overflow-hidden rounded-2xl border border-[#60A5FA]/10 bg-[#60A5FA]/3 p-6 opacity-60">
                    <div class="absolute top-3 right-3">
                        <span class="text-[10px] font-mono font-medium text-white/20 bg-white/5 px-2 py-0.5 rounded-full">SOON</span>
                    </div>
                    ...
                    <h3 class="font-display text-lg font-bold text-white/50 mb-1">Star Wars</h3>
                    <p class="text-xs text-white/20 leading-relaxed">Films, series, and animated shows in one timeline.</p>
                </div>
                ...
                <div class="relative overflow-hidden rounded-2xl border border-[#7C3AED]/10 bg-[#7C3AED]/3 p-6 opacity-60">
                    ...
                    <h3 class="font-display text-lg font-bold text-white/50 mb-1">Wizarding World</h3>
                    <p class="text-xs text-white/20 leading-relaxed">Harry Potter and Fantastic Beasts in chronological order.</p>
                </div>
                ...
                <div class="relative overflow-hidden rounded-2xl border border-[#22C55E]/10 bg-[#22C55E]/3 p-6 opacity-60">
                    ...
                    <h3 class="font-display text-lg font-bold text-white/50 mb-1">Fast & Furious</h3>
                    <p class="text-xs text-white/20 leading-relaxed">The complete saga including spinoffs, in story order.</p>
                </div>
            </div>
        </div>
        ...
        <div v-if="!isLoggedIn" class="max-w-4xl mx-auto px-4 sm:px-6">
            <div class="text-center mb-8">
                <h2 class="font-display text-2xl sm:text-3xl font-bold tracking-tight text-white mb-2">Why Canonkeeper?</h2>
                <p class="text-white/30 text-sm">Everything you need to navigate any franchise.</p>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div class="glass-card p-6 text-center">
                    <div class="w-10 h-10 rounded-xl bg-[#F5A623]/10 flex items-center justify-center mx-auto mb-3">
                    ...
                    <h3 class="font-display text-sm font-bold tracking-wide text-white mb-1">TIMELINE</h3>
                    <p class="text-xs text-white/30 leading-relaxed">Scroll through the full canon in chronological order.</p>
                </div>
                <div class="glass-card p-6 text-center">
                    ...
                    <h3 class="font-display text-sm font-bold tracking-wide text-white mb-1">SPOILER GUARD</h3>
                    <p class="text-xs text-white/30 leading-relaxed">Automatic protection for unwatched content.</p>
                </div>
                <div class="glass-card p-6 text-center">
                    ...
                    <h3 class="font-display text-sm font-bold tracking-wide text-white mb-1">KEEPER SCORE</h3>
                    <p class="text-xs text-white/30 leading-relaxed">Earn XP, level up, and collect badges as you watch.</p>
                </div>
            </div>
        </div>
        ...
        <div v-if="isLoggedIn && nextUp" class="max-w-4xl mx-auto px-4 sm:px-6">
            <h2 class="font-display text-xl font-bold tracking-tight text-white mb-4">Next Up</h2>
            <NuxtLink :to="`/title/${nextUp.slug}`" class="glass-card p-5 flex items-center gap-5 group">
                <div class="w-16 h-24 rounded-lg bg-[#F5A623]/5 shrink-0 overflow-hidden border border-[#F5A623]/10 group-hover:border-[#F5A623]/30 transition-colors">
                    <div class="w-full h-full flex items-center justify-center">
                        <span class="font-display text-lg font-bold text-[#F5A623]/30">{{ nextUp.chronology_index }}</span>
                    </div>
                </div>
                <div class="flex-1 min-w-0">
                    <h3 class="font-display text-lg font-bold tracking-tight text-white group-hover:text-[#F5A623] transition-colors truncate">
                        {{ nextUp.title }}
                    </h3>
                ...
                <svg class="w-5 h-5 text-white/20 group-hover:text-[#F5A623]/60 transition-colors shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div v-if="isLoggedIn && upcomingReleases.length > 0" class="max-w-4xl mx-auto px-4 sm:px-6">
            <h2 class="font-display text-xl font-bold tracking-tight text-white mb-4">Upcoming Releases</h2>
            <div class="space-y-2">
                <NuxtLink
        ...
        <div class="text-center space-y-2">
            <span class="text-xs text-white/15 font-mono">{{ totalTitles }} titles in the MCU</span>
            <p class="text-[10px] text-white/10">Canonkeeper is not affiliated with Marvel, Disney, or any franchise owner.</p>
        </div>
    </div>
</template>
